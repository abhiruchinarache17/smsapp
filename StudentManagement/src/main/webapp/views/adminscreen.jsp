...
<style type="text/css"> 
   .enroll{ 
   background-image: url("images/backto1st.jpg"); 
   ...
   .view{ 
      background-image: url("images/backto2.webp"); 
   background-size: cover; 
   background-repeat: no-repeat; 
   } 
 </style> 
...
name="studentFullName"/> 
                    <label class="form-label" for="firstName">student FullName</label> 
                  </div> 
   ...
   <input type="tel" id="text" class="form-control form-control-sm" name="studentCollageName"/> 
              ...
              <div class="row"> 
                <div class="col-md-6 mb-2 pb-2"> 
                  ...
                  <div class="form-outline"> 
   <input type="number" id="emailAddress" class="form-control form-control-sm" name="fessPaid"/> 
                    <label class="form-label" for="emailAddress">fess Paid</label> 
                  </div> 
        ...
        <tbody>
         <c:forEach items="${data}" var="s"> 
          <tr> 
           ...
           <button class="btn btn-outline-success" onclick="fess()">Pay-fess</button> 
